...
def generate_launch_description():
    ...
    robot_arg = DeclareLaunchArgument(
        'robot',
        default_value=TextSubstitution(text='ranger_mini_v3_webots.urdf'),
    ...
    four_wheel_steering_controller_spawner = Node(
    ...
    ros_control_spawners = [four_wheel_steering_controller_spawner, joint_state_broadcaster_spawner]
